...
class FetchDataStreamDocuments<E extends Entity>{
  ...
  Stream<List<E>> fetchStreamWithParametersPassingListParameters({required String collection,required String parameter, required List<String> value, required Function({required Map<String, dynamic> data}) createEntity}) {
  ...
  Stream<List<E>> fetchStreamWithSingleParameter({required String collection,required String parameter, required  value, required Function({required Map<String, dynamic> data}) createEntity}) {
