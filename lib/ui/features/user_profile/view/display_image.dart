                        ...
                        Transform.scale(
                          ...
                          child: InkWell(
                            ...
                            child: const Padding(
                              ...
                              child: DSIconSmallSecondary(iconName: 'account',),
                            ),
                          ),
                        ),
                        const SizedBox(height: 12,),
                        const Text('Add a photo', style: TextStyle(fontSize: 12),),
                      ],
                    ),
                  )
                      : userProvider.profilePicturePath.substring(0, 6) == 'https:'? CircleAvatar(
                    backgroundImage: NetworkImage(userProvider.profilePicturePath),
                    radius: 70,
                  )
                      : CircleAvatar(
                    backgroundImage: FileImage(File(userProvider.profilePicturePath)),
                    radius: 70,
                  ),
                  Positioned(
                    right: 4,
                    ...
                    child: Transform.scale(
                      ...
                      child: Card(
                        ...
                        child: InkWell(
                          ...
                          child: const Padding(
                            padding: EdgeInsets.all(3.0),
                            child: DSIconSmallSecondary(iconName: 'camera',),
                          ),
                        ),
                      ),
                    ),
