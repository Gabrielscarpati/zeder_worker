...
class _ChooseCityScreenState extends State<ChooseCityScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final PesquisaCidadeProvider _Provider =
        context.watch<PesquisaCidadeProvider>();
    ...
    return Scaffold(
        body: Column(
          ...
          children: [
                        ...
                        children: [
                          Text(
                            getLocation.locationBR
                                ? 'Eu Trabalho nessas ciadades'
                                : "I work in these cities",
                            style: TextStyle(
            ...
            ListBuilderCities(
              cities: _Provider.list_cities_screen,
              paddig: padding,
            ),
          ],
        ),
