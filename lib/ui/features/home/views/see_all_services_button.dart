...
class SeeAllServicesButton extends StatelessWidget {
  ...
  const SeeAllServicesButton(
      {Key? key,
      required this.title,
      required this.servicos,
      required this.allowGetLeads,
      required this.newServico,
      required this.currentServico})
      : super(key: key);
    ...
    return InkWell(
      ...
      onTap: () {
        newServico
            ? Navigator.push(
                context,
                MaterialPageRoute(
                    builder: (context) => const ShowNewServicesScreen()),
              )
            : Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (context) => const ShowCurrentServicesScreen(),
                ),
              );
      },
      ...
      child: Row(
        ...
        children: [
          SizedBox(
            child: Text(
              getLocation.locationBR ? "Ver todos" : "See all",
          ...
          const DSIconSmallPrimary(iconName: 'magnify'),
        ],
      ),
    );
  }
