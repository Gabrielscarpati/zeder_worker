...
import 'confirmar_abertura_disputa_footer_viewmodel.dart';

class ConfirmarAberturaDisputaFooter extends StatelessWidget {
  final ConfirmarAberturaDispultaFooterViewModel viewModel;
  ...
  Widget get barraBotoes => Padding(
    ...
    child: Column(
      ...
      children: [
        ...
        BotaoPadraoGrande(texto: 'INICIAR DISPUTA',
