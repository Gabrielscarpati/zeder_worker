...
void main() {
 ...
 test('AvaliacaoPrestadorEntity.constructor: deve criar um objeto com os respectivos valores', () {
   AvaliacaoPrestadorEntity entity = AvaliacaoPrestadorEntity(id: '1', prestador_id: '1234', id_cliente: '4567', nota: 4.5656, comentario: 'muito bom', data:DateTime(2023, 02, 05), );
    expect(entity.id, "1");
    expect(entity.prestador_id, "1234");
    expect(entity.id_cliente, "4567");
  ...
  test('AvaliacaoPrestadorEntity.fromJson: deve criar um objeto com os respectivos valores passados no json', () {
    AvaliacaoPrestadorEntity entity = AvaliacaoPrestadorEntity.fromJson({"id": '1', "prestador_id": '1234', "id_cliente": '4567', "nota": 4.5656, "comentario": 'muito bom', "data":DateTime(2023, 02, 05),});
    expect(entity.id, "1");
    expect(entity.prestador_id, "1234");
    expect(entity.id_cliente, "4567");
    expect(entity.nota, 4.5656);
  ...
  test('AvaliacaoPrestadorEntity.fromJson: deve criar um objeto com os respectivos valores "default" quando o json for vazio', () {
      ...
      expect(entity.id, '');
      expect(entity.prestador_id, '');
      expect(entity.id_cliente, '');
  ...
  test('AvaliacaoPrestadorEntity.toJson: deve retornar um json com os respectivos valores do obje', () {
    ...
    expect(map['id'], "1");
    expect(map['prestador_id'], "1234");
    expect(map['id_cliente'], "4567");
    expect(map['nota'], 4.5656);
    expect(map['comentario'], "muito bom");
    expect(map['data'], DateTime(2023, 02, 05));
  });
  ...
  test('AvaliacaoPrestadorEntity.copyWith: deve retornar uma copia do objeto com os respectivos valores passados nos paramentros', () {
    ...
    expect(entity.copyWith().prestador_id, "1234");
    expect(entity.copyWith(prestador_id:'12').prestador_id, "12");

    expect(entity.copyWith().id_cliente, "4567");
    expect(entity.copyWith(id_cliente:'123').id_cliente, "123");
