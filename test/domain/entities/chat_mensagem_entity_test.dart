...
void main() {
  test(
      'ChatMensagemEntity.constructor: deve criar um objeto com os respectivos valores',
      () {
  ...
  test(
      'ChatMensagemEntity.fromJson: deve criar um objeto com os respectivos valores passados no json',
      () {
  ...
  test(
      'ChatMensagemEntity.fromJson: deve criar um objeto com os respectivos valores "default" quando o json for vazio',
      () {
    ChatMensagemEntity entity = ChatMensagemEntity.fromJson({});
    expect(entity.id, "");
  ...
  test(
      'ChatMensagemEntity.toJson: deve retornar um json com os respectivos valores do objeto',
      () {
      ChatMensagemEntity entity = ChatMensagemEntity.fromJson({
        "id": "1",
        "idChat": "2",
  ...
  test(
      'ChatMensagemEntity.copyWith: deve retornar uma copia do objeto com os respectivos valores passados nos paramentros',
      () {
    ChatMensagemEntity entity = ChatMensagemEntity.fromJson({
        "id": "1",
        "idChat": "2",
